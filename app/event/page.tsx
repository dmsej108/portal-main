...
export default function Event() {
  ...
  const [cntPerPage, setCntPerPage] = useState(10); // 페이지당 건수
  const [itemCount, setItemCount] = useState(200); // 총 건수
  return (
    <div className="tbl-wrap" >
      ...
      <div className="table-util flex space-between">
        ...
        <div className="btn-set-m flex align-end">
          <button type="button" className="btn btn-ss" onClick={() => router.push('/event/regist')}>등록</button>
        </div>
        <div className="btn-set-m flex align-end">
