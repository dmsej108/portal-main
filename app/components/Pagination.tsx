export default function Pagination({ itemCount, cntPerPage, currentPage, onChangedPage }: { itemCount: number, cntPerPage: number, currentPage: number, onChangedPage: (pageNo: number, eventFlag: boolean) => void }) {
    // 전체 페이지 수 계산
